...
@Component({
    selector: 'app-caricature-module',
    templateUrl: './caricature-module.component.html',
    styleUrls: ['./caricature-module.component.css'],
    animations: [
...
export class CaricatureModuleComponent implements OnInit {
